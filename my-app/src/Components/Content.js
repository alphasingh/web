                 ...
                 {seller.map(seller=>(
                     ...
                     <div className="card mt-4">
                        ...
                        <div className="card-body">
                           ...
                           <p className="card-text text-secondary" ><h6><strong>Categories available :</strong></h6> <h6 style={{color:"red"}}> {preparations(seller.preparations)}</h6></p>
                           <p className="card-text text-secondary" style={{maxHeight:"10px", marginBottom:"30px"}}><h6><strong>Cuisines available : </strong>{preparations(seller.regions)}</h6></p>
                        </div>
             ...
             <div className="row">
                ...
                <div className="container">
                  ...
                  {/* <img src="Images/new-tiffin-2.jpeg" alt="Cinque Terre" width="600" height="400"></img> */}
                      <RestaurantRoundedIcon className="icons-style" width="33%"/> 
                      <LocationOnRoundedIcon className="icons-style" width="33%"/>
                      <EventAvailableRoundedIcon className="icons-style" width="33%"/>
                  </div>
                </div>
